...
public class CustomerController {
	...
	public ResponseEntity<HttpStatus> syncAzureProductToDB(@RequestParam("syncType") Integer syncType) {
		logger.info("*** CustomerController >> syncJSONDataToDB >> [START]");
...
//			}
	...
	public ResponseEntity<List<Map<String, Object>>> retrievePromoIssuanceLookup(
			@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> retrievePromoIssuanceLookup >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		HashMap<String, Object> paramMap = new HashMap<>();
		...
		logger.info("*** CustomerController >>promoType: " + promoType);
		...
		String quertTxt = "SELECT distinct  promo_code as 'promoCode'\r\n" + "  , promo_name as 'promoName'\r\n"
				...
				+ "FROM cms_db.promo_issuance_lkp " + " WHERE promo_code is not null " + promoType
				+ " ORDER BY updateDate desc ";

		List<Map<String, Object>> dataList = queryBuilderService.getExecQuery(quertTxt);
		logger.info("*** CustomerController >> retrievePromoIssuanceLookup >> [END]");
		return new ResponseEntity<List<Map<String, Object>>>(dataList, httpStat);
	}
	...
	public ResponseEntity<List<Map<String, Object>>> retrieveTempAutoIssuance(
			@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> retrieveTempAutoIssuance >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		HashMap<String, Object> paramMap = new HashMap<>();
		paramMap.putAll(paramBody);
		...
		logger.info("*** CustomerController >> retrieveTempAutoIssuance >> [END]");
		return new ResponseEntity<List<Map<String, Object>>>(dataList, httpStat);
	}
	...
	public ResponseEntity<List<Map<String, Object>>> retrieveAutoIssuanceCustomers(
			@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> retrieveAutoIssuanceCustomers >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		HashMap<String, Object> paramMap = new HashMap<>();
		paramMap.putAll(paramBody);
		List<Map<String, Object>> dataList = issuanceMapper.getNPDIssuanceList(paramMap);
		...
		logger.info("*** CustomerController >> retrieveAutoIssuanceCustomers >> [END]");
		return new ResponseEntity<List<Map<String, Object>>>(dataList, httpStat);
	}
	...
	public ResponseEntity<Boolean> addTempAutoIssuance(@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> addTempAutoIssuance >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		logger.info("*** CustomerController >> paramBody: " + paramBody);
					...
					if (CollectionUtils.isNotEmpty(dbProducts)) {
						...
						try {
							...
							if (MapUtils.isNotEmpty(eProduct)) {
								logger.info("*** CustomerController >> addTempAutoIssuance >> eProduct: " + eProduct);
								...
								logger.info("*** CustomerController >> addTempAutoIssuance >> variantId: " + variantId);
								...
								String quertTxt = "insert into cms_db.temp_auto_issuance (promo_code, warehouse_code, customer_no, item_id, item_variant_id, item_prod_id, qty_issuance)\r\n"
										+ "values ('" + promoCode + "' " + ", '" + warehouse + "'" + ", '" + storeCustNo
										+ "'" + ", '" + itemId + "'" + ", '" + variantId + "'" + ", '" + shopProdId
										+ "'" + ", " + itemQty + ");";

								save = queryBuilderService.execQuery(quertTxt);
								logger.info("*** CustomerController >> addTempAutoIssuance >> save: " + save);
							}
		...
		logger.info("*** CustomerController >> addTempAutoIssuance >> [END]");
		return new ResponseEntity<Boolean>(save, httpStat);
	}

	public ResponseEntity<Boolean> addAutoIssuanceCustomer_10162023(@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> addAutoIssuanceCustomer >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		logger.info("*** CustomerController >> paramBody: " + paramBody);
		Map<String, Object> dataMap1 = (Map<String, Object>) paramBody.get("param1");// PROMO
		Map<String, Object> dataMap2 = (Map<String, Object>) paramBody.get("param2");// WAREHOUSE
				...
				for (Map<String, Object> productMap : dataMap3) {
					...
					if (CollectionUtils.isNotEmpty(dbProducts)) {
						...
						try {
							...
							if (MapUtils.isNotEmpty(eProduct)) {
								logger.info(
										"*** CustomerController >> addAutoIssuanceCustomer >> eProduct: " + eProduct);
								List<Map<String, Object>> prodVariants = (List<Map<String, Object>>) eProduct
										.get("variants");
								Map<String, Object> variantMap = prodVariants.get(0);// FIRST Variant WITH PRICE
...
//								}  
								...
								Long variantId = NumberUtil.getLongValue(variantMap, "id");
								logger.info(
										"*** CustomerController >> addAutoIssuanceCustomer >> variantId: " + variantId);
								String itemQty = String.valueOf(productMap.get("itemQty"));
								...
								save = queryBuilderService.execQuery(quertTxt);
								logger.info("*** CustomerController >> addAutoIssuanceCustomer >> save: " + save);
							}
		...
		logger.info("*** CustomerController >> addAutoIssuanceCustomer >> [END]");
		return new ResponseEntity<Boolean>(save, httpStat);
	}
	...
	public ResponseEntity<Boolean> addAutoIssuanceCustomer(@RequestBody Map<String, Object> paramBody) {
		...
		List<Map<String, Object>> dataMap4 = (List<Map<String, Object>>) paramBody.get("param4");// STORES
		boolean save = false;
		if (MapUtils.isNotEmpty(dataMap1) && CollectionUtils.isNotEmpty(dataMap3)
				&& CollectionUtils.isNotEmpty(dataMap4)) {
			...
			for (Map<String, Object> storeMap : dataMap4) {
				...
				try {
					...
					delMap.put("promoCode", promoCode);
					delMap.put("customerNo", storeCustNo);
					int delResult = issuanceMapper.deleteNPDIssuance(delMap);
					logger.info("*** CustomerController >> addAutoIssuanceCustomer >> delResult: " + delResult);
				} catch (Exception e) {
					logger.log(Level.SEVERE, e.getMessage(), e);
				}
				...
				for (Map<String, Object> productMap : dataMap3) {
					...
					logger.info("*** CustomerController >> addAutoIssuanceCustomer >> productMap: " + productMap);
					...
					if (CollectionUtils.isNotEmpty(dbProducts)) {
						...
						try {
							logger.info("*** CustomerController >> addAutoIssuanceCustomer >> dbProduct: " + dbProduct);
							
							Long shopProdId = (long) dbProduct.get("shopProdId");
							Map<String, Object> eProduct = onlineProductService.getOneProduct(shopProdId);
							if (MapUtils.isNotEmpty(eProduct)) {
								logger.info( "*** CustomerController >> addAutoIssuanceCustomer >> eProduct: " + eProduct);
								List<Map<String, Object>> prodVariants = (List<Map<String, Object>>) eProduct
										.get("variants");
								Map<String, Object> variantMap = prodVariants.get(0);// FIRST Variant WITH PRICE
								
								Long variantId = NumberUtil.getLongValue(variantMap, "id");
								logger.info("*** CustomerController >> addAutoIssuanceCustomer >> variantId: " + variantId);
								String itemQty = String.valueOf(productMap.get("itemQty"));
								String quertTxt = "insert into cms_db.store_auto_issuance (promo_code, customer_no, item_id, item_variant_id, item_prod_id, free_flag, qty_issuance)\r\n"
										+ "values ('" + promoCode + "' , '" + storeCustNo
										+ "'" + ", '" + itemId + "'" + ", '" + variantId + "'" + ", '" + shopProdId
										+ "'" + ", '" + freeFlagTxt + "'" + ", " + itemQty + ");";
	...
	public ResponseEntity<Boolean> deletePromoIssuanceLkp(@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> deletePromoIssuanceLkp >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		...
		if (MapUtils.isNotEmpty(dataMap)) {
			try {
				...
				String quertTxt = "delete from cms_db.promo_issuance_lkp " + " WHERE promo_code = '" + promoCode + "'";
				deleted = queryBuilderService.execQuery(quertTxt);
				logger.info("*** CustomerController >> deleted: " + deleted);
			} catch (Throwable e) {
				logger.log(Level.SEVERE, e.getMessage(), e);
			}
		}

		logger.info("*** CustomerController >> deletePromoIssuanceLkp >> [END]");
	...
	public ResponseEntity<Boolean> deleteAutoIssuanceCustomer(@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> deleteAutoIssuanceCustomer >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		logger.info("*** CustomerController >> paramBody: " + paramBody);
		...
		if (CollectionUtils.isNotEmpty(dataMapList)) {
			for (Map<String, Object> dataMap : dataMapList) {
				...
				String quertTxt = "delete from cms_db.store_auto_issuance " + " WHERE promo_code = '" + promoCode + "'"
						+ "   and customer_no = '" + customerNo + "'"  ;
				deleted = queryBuilderService.execQuery(quertTxt);
				logger.info("*** CustomerController >> dataId: " + dataId + " >> DELETED: " + deleted);
				if (deleted) {
					try {
		...
		logger.info("*** CustomerController >> deleteAutoIssuanceCustomer >> [END]");
		return new ResponseEntity<Boolean>(deleted, httpStat);
	}
	...
	public ResponseEntity<Boolean> publishAutoIssuance(@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> publishAutoIssuance >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		logger.info("*** CustomerController >> paramBody: " + paramBody);
		List<Map<String, Object>> dataMapList = (List<Map<String, Object>>) paramBody.get("param1");
		boolean success = false;
		...
		if (CollectionUtils.isNotEmpty(dataMapList)) {
			...
			for (Map<String, Object> dataMap : dataMapList) {
				...
				try {
					logger.info("*** CustomerController >> dataMap: " + dataMap);
					String promoCode = String.valueOf(dataMap.get("promoCode"));
					String customerNo = String.valueOf(dataMap.get("customerNo"));
					...
					if (CollectionUtils.isNotEmpty(itemDetailList)) {
						...
						StringBuilder metaValue = new StringBuilder("PROMO_").append(promoName).append("|")
								.append("CNO_").append(customerNo).append("|").append("EFFC_START_")
								.append(effectStartDate).append("|").append("EFFC_END_").append(effectEndDate)
								.append("|").append("ISSUE_FLG_").append(issuedFlag).append("|").append("OOS_ENBL_")
								.append(oosEnabled).append("|").append("ITMLINE_");
						for (Map<String, Object> itemLineMap : itemDetailList) {
							...
							metaValue.append(itemName).append(" (").append(itemId).append(")").append("=")
									.append(itemProdId).append("=").append(itemVariantId).append("=").append(qty)
									.append(":");
						}
		...
		logger.info("*** CustomerController >> publishAutoIssuance >> [END]");
	...
	public ResponseEntity<Boolean> addPromoIssuance(@RequestBody Map<String, Object> paramBody) {
		logger.info("*** CustomerController >> addPromoIssuance >> [START]");
		HttpStatus httpStat = HttpStatus.OK;
		logger.info("*** CustomerController >> paramBody: " + paramBody);
		Map<String, Object> dataMap = (Map<String, Object>) paramBody.get("param1");
		boolean save = false;
		if (MapUtils.isNotEmpty(dataMap)) {
			...
			save = queryBuilderService.execQuery(quertTxt);
			logger.info("*** CustomerController >> save: " + save);
		}
		logger.info("*** CustomerController >> addPromoIssuance >> [END]");
		return new ResponseEntity<Boolean>(save, httpStat);
	}
	...
	@PostMapping("/lockStoreAccount")
	public ResponseEntity<Boolean> lockStoreAccount(@RequestBody Map<String, Object> paramBody)
			throws Throwable {
		boolean success = false;
		HttpStatus httpStat = HttpStatus.OK;
		Gson gson = new GsonBuilder().setPrettyPrinting().create();
		logger.info("** SupportToolController >> lockStoreAccount >> [START]");
		logger.info("** SupportToolController >> paramBody: " + paramBody);
		try {
			
			String customerNo = (String)paramBody.get("customerNo");
			String moduleAcctType = (String)paramBody.get("moduleAcctType");
		    boolean lockAccount = (Boolean)paramBody.get("lockAccount");
		    String orderName = (String)paramBody.get("orderName");
			    
		    HashMap<String, Object> paramMap = new HashMap<String, Object>();
		    paramMap.put("disableAcct", lockAccount? "Y":"N");
		    paramMap.putAll(paramBody);
		     
		    int result = ewtMapper.updateEWTOrderInfo(paramMap);
		    if (result!=0) {
		    	Map<String, Object> rootMap = new LinkedHashMap<String, Object>();
				Map<String, Object> detailMap = new LinkedHashMap<String, Object>();
				
				detailMap.put("namespace", moduleAcctType);
				detailMap.put("key", customerNo);
				detailMap.put("value", gson.toJson(paramBody, Map.class));
				...
				logger.info("** SupportToolController >> lockStoreAccount >> rootMap: " + rootMap);
				success = true;
		    }
		...
		logger.info("** SupportToolController >> lockStoreAccount >> [END]");
		return new ResponseEntity<Boolean>(success, httpStat);
	}
}
